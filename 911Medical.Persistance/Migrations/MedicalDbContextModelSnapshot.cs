...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_911Medical.Domain.Entities.VehicleState", b =>
                {
                    b.Property<int>("VehicleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_911Medical.Domain.Entities.Patient", b =>
                {
                    b.OwnsOne("_911Medical.Domain.Entities.Patient.HomeAddress#_911Medical.Domain.Entities.Address", "HomeAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("_911Medical.Domain.Entities.Trip", b =>
                {
                    ...
                    b.OwnsOne("_911Medical.Domain.Entities.Trip.StartAddress#_911Medical.Domain.Entities.Address", "StartAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("_911Medical.Domain.Entities.VehicleState", b =>
                {
                    b.HasOne("_911Medical.Domain.Entities.Vehicle", "Vehicle")
                        .WithOne("State")
                        .HasForeignKey("_911Medical.Domain.Entities.VehicleState", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
